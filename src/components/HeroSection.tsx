  ...
  const features = [
    {
      ...
      title: t('hero.features.printing.title'),
      description: t('hero.features.printing.description')
    },
    {
      icon: <LayoutGrid className="h-5 w-5 text-orange-500" />,
      title: t('hero.features.design.title'),
      description: t('hero.features.design.description')
    },
    {
      icon: <Palette className="h-5 w-5 text-purple-500" />,
      title: t('hero.features.materials.title'),
      description: t('hero.features.materials.description')
    }
  ];
          ...
          <div className="order-2 md:order-1">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                {t('hero.title')}
                {" "}
                <span className="text-gradient-mixed">{t('hero.subtitle')}</span>
              </h1>
            ...
            >
              ...
              <div className="absolute -bottom-6 -right-6 bg-orange-50 border border-orange-200 rounded-lg p-4 w-48">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs font-medium">{t('hero.stats.title')}</span>
                </div>
                <div className="mt-2 text-2xl font-bold">98%</div>
                <div className="text-xs text-gray-500">{t('hero.stats.description')}</div>
              </div>
            </motion.div>
